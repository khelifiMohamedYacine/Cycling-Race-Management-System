...
public class CyclingPortalGetRiderResultsInStageTest {
    public static void main(String[] args) throws Exception  {
        ...
        try {
            ...
            portal.getRiderResultsInStage(stage1Id , nonExistentRiderId);
        ...
        try {
            ...
            portal.getRiderResultsInStage(nonExistentStageId , rider1Id);
        ...
        try {
            int nonExistentRiderId = -1;
            int nonExistentStageId = -1;
            portal.getRiderResultsInStage(nonExistentStageId , nonExistentRiderId);
            System.err.println("Rider " + nonExistentRiderId +" should not be created");
            System.err.println("Stage " + nonExistentStageId +" should not be created");
        } catch (IDNotRecognisedException e) {
            System.out.println("the ID does not match to any Rider and any Stage in the system");
        }
    }
}
