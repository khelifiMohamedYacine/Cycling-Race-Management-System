...
public class CyclingPortalGetRidersMountainPointsInRaceTest {
    public static void main(String[] args) throws Exception  {
        ...
        int[] RidersMountainPointsInRace = portal.getRidersMountainPointsInRace(Race1Id);
        System.out.println("\nRiders Mountain Points In Race");
        System.out.println(Arrays.toString(RidersMountainPointsInRace));

        try {
            int nonExistentRaceId = -1;
            portal.getRidersPointsInRace(nonExistentRaceId);
