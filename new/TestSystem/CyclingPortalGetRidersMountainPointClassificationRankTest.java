...
public class CyclingPortalGetRidersMountainPointClassificationRankTest {
    public static void main(String[] args) throws Exception  {
        ...
        int[] RidersPointsInRace = portal.getRidersPointsInRace(Race1Id);
        System.out.println("\nRiders Points In Race:");
        System.out.println(Arrays.toString(RidersPointsInRace));

        int[] RidersPointClassificationRank = portal.getRidersPointClassificationRank(Race1Id);
        System.out.println("\nRiders Point Classification Rank");
        System.out.println(Arrays.toString(RidersPointClassificationRank));

        int[] RidersMountainPointClassificationRank = portal.getRidersMountainPointClassificationRank(Race1Id);
        ...
        try {
            ...
            portal.getRidersMountainPointClassificationRank(nonExistentRaceId);
