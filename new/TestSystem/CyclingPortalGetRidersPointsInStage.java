...
public class CyclingPortalGetRidersPointsInStage {
    public static void main(String[] args) throws Exception {
        ...
        int[] RidersPointsInStage = portal.getRidersPointsInStage(stage1Id);
        System.out.println("\nRiders Points in Stage 1:");
        System.out.println(Arrays.toString(RidersPointsInStage));

        try {
            int nonExistentStageId = -1;
            portal.getRidersRankInStage(nonExistentStageId);
            System.err.println("Rider " + nonExistentStageId +" should not be created");
